 ...
 */
export class ZeebeSimpleMonitor extends Construct {
  ...
  private SIMPLE_MONITOR_VERSION: string = '2.4.0';
  ...
  private initProps(options?: Partial<ZeebeStandaloneProps>): ZeebeStandaloneProps {
    ...
    const defaults = {
      ...
      containerImage: ContainerImage.fromRegistry('ghcr.io/camunda-community-hub/zeebe-simple-monitor' + this.SIMPLE_MONITOR_VERSION),
